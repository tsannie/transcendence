import { canvas_back_height, canvas_back_width, paddle_height, paddle_p1_x, paddle_p2_x, paddle_width, rad, spawn_gravity, spawn_speed, speed } from "./const/const";
...
export function BallCol_p1(set: SetEntity, paddle: any) {
...
export function BallCol_p2(set: SetEntity, paddle: any) {
